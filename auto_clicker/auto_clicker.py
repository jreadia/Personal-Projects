...
class AutoClickerApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.tray_icon.setIcon(QIcon("click.ico"))  # Update the icon path to click.ico
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon("C:/4 - CODING FILES/PERSONAL FOLDER/auto_clicker/click.ico"))  # Set the window icon
